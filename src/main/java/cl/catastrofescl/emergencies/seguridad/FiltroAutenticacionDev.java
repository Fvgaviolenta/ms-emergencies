 ...
 *
 * <p>Lee headers de desarrollo o, si {@code trustGatewayFirebaseHeaders} esta activo,
 * confia en {@code X-Firebase-Uid} inyectado por el API Gateway tras validar el Bearer.</p>
 */
@Slf4j
public class FiltroAutenticacionDev extends OncePerRequestFilter {
    ...
    /** Inyectado por el API Gateway tras validar el Bearer Firebase (solo entornos de confianza). */

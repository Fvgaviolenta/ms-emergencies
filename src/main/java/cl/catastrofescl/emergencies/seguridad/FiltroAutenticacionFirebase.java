 ...
 * Si el token es valido pero no trae roles y se configuro {@code rolesPorDefectoSiSinClaims}
 * (laboratorio), se asignan esos roles para evitar 403 por claims no sincronizados.
 */
@Slf4j

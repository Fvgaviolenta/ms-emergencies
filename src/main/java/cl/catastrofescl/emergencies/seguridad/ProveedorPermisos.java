...
/**
 * Resuelve permisos del modulo EMERGENCIAS a partir de roles internos.
 *
 * <p>Carga {@code classpath:rbac/permisos-por-rol-emergencias.yml}. Los tokens Firebase
...
public class ProveedorPermisos {
    ...
    public static final String EMERGENCIA_DECLARAR = "EMERGENCIA_DECLARAR";
    public static final String EMERGENCIA_GESTIONAR = "EMERGENCIA_GESTIONAR";
    public static final String ANUNCIO_PUBLICAR = "ANUNCIO_PUBLICAR";

    private static final String UBICACION_RBAC = "classpath:rbac/permisos-por-rol-emergencias.yml";
